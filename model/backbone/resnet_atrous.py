    ...
    def __init__(self, frozen_layers=()):
        ...
        if isinstance(frozen_layers, str):
            if frozen_layers.lower() == 'none':
                ...
                raise ValueError('Unknown option for frozen layers: \"{}\". Should be \"all\", \"none\" or list of '
                                 'layer names.'.format(frozen_layers))
...
class ResNet(Backbone):
    def __init__(self, block, layers, used_layers, frozen_layers=()):
        self.inplanes = 64
